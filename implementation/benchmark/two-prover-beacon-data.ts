...
import { BeaconStoreProver, BeaconStoreVerifier } from '../src/store/beacon-store';
...
async function main() {
  ...
  const superLightClient = new SuperlightClient(beaconStoreVerifer, [dishonestBeaconProver, honestBeaconProver]);
